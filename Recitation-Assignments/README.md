...
* Train neural network models (at least two different networks for each dataset, i.e., no. layers, no. neurons, activation, regulization, ...) in either Tensorflow or Pytorch to peroform classification on the following datasets, then compare them with models in previous assignments:
