...
* Solutions of the exercises as well as mathematical notations could be written in [Latex](https://github.com/hhaji/Applied-Machine-Learning#latex), either in jupyter notebook or pdf. MS Office or any other software could also be used, otherwise images of your handwriting should be included, which is not recommended! Please acknowledge which one is used.
