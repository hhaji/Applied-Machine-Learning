...
9. ### <a name="Decision-Trees"></a>Decision Trees  
 ...
 - Blog: [Random Forests in Python](http://blog.yhat.com/posts/random-forests-in-python.html)
   - NoteBook: [Random Forest Classifier Example](https://chrisalbon.com/machine_learning/trees_and_forests/random_forest_classifier_example/) by Chris Albon <br> 
